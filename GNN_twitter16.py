...
def plot_loss_curves(train_losses, val_losses, dataset="twitter16", model_name="model", plot_title="Loss Curves"):
...
def plot_conf_matrix(true_labels, pred_labels, classes, dataset="twitter16", model_name="model", plot_title="Confusion Matrix"):
    folder = create_folder(dataset, model_name)
...
def plot_roc_curves(true_labels, test_prob, num_classes, dataset="twitter16", model_name="model", plot_title="ROC Curves"):
    folder = create_folder(dataset, model_name)
